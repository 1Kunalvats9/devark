  ...
  return (
    <section id="hero" ref={containerRef} className="relative h-screen w-full mt-10 md:mt-0 overflow-hidden bg-[#050505]">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — CREATIVE AGENCY</p>
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">02 — DIGITAL INNOVATION</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            EXPERT
            <br />
